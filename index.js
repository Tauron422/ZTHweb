...
import {createDeeplink}  './createDeeplink';
...
let bottom_oplata = document.getElementById('transaction-link')
bottom_oplata.onclick = function() {
  payload.amountPlanck = bottom_oplata.value;
};
...
async function updatePlayerDetailsAndContract() {
    ...
    document.getElementById('player_tmg_quantity_2').innerText = tmgAssetQuantity
